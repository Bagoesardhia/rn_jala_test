    ...
    return(
        ...
        <ScrollView style={styles.container}>
            <View style={styles.containerAtas}>
                <Text style={styles.fontPrimary}>{route.params.data.region.province_name}</Text>
            ...
            <View style={styles.containerIsi}>
                ...
                <View style={styles.containerGambar}>
                    ...
                    style={styles.gambar}
                    />
                <Text style={styles.fontSupp}>{route.params.data.creator.name}</Text>
                </View>
                
                <Text style={styles.fontThird}>Kontak</Text>
                <View style={styles.containerHarga}>
                    <Text style={styles.fontPrimary}>{route.params.data.creator.phone}</Text>
                    ...
                    <Text style={styles.fontPrimary}>Daftar Harga</Text>
                ...
                <Text style={styles.fontPrimary}>Catatan</Text>
