...
const Penyakit = () => {
        ...
        return(
            <View style={styles.containerflat}>
                ...
                <View style = {styles.containerisi}>
                    ...
                    <Text style = {styles.subTitle}>{item.short_name}</Text>
                    <Text style = {styles.excerpt}>{item.meta_description}</Text>
                    <Text style = {styles.excerpt}>{item.created_at}</Text>
                </View>
            </View>
        )
    }
    ...
    return(
        <SafeAreaView style = {styles.container}>
            ...
            <Text style = {styles.judul}>Daftar Penyakit</Text>
